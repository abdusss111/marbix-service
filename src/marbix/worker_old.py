...
# Remove real-time status updates from worker - WebSocket polls database instead
...
async def generate_strategy(ctx, request_id: str, user_id: str, request_data: Dict[str, Any], **kwargs):
    ...
    **kwargs accepts ARQ internal parameters like _job_timeout, _max_tries, etc.
    ...
    try:
        ...
        # Step 1: Worker started - log only
        logger.info(f"Worker started for {request_id}, initializing research phase")
